...
export default function Contact() {
  ...
  return (
    <div className="w-full flex-1 flex items-center py-8">
      <div className="w-full max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        <div className="text-center mb-10">
          <h1 className="text-3xl font-bold text-center mb-3">Get In Touch</h1>
        ...
        <div className="grid grid-cols-1 gap-8">
          ...
          <motion.div
            ...
            className="bg-gradient-to-br from-[#2b2151] to-[#1b133c] rounded-xl p-6 sm:p-8 shadow-2xl shadow-indigo-500/10 hover:shadow-3xl hover:shadow-indigo-500/20 transition-all duration-300"
          >
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <button
                ...
                className={`w-full py-2.5 px-4 text-sm rounded-lg font-medium transition-colors duration-300 ${
                  isSubmitting
